...
const features: FeatureItem[] = [
  {
    ...
    title: "Visual Search",
    description: "Find products instantly by snapping a photo.",
    image: "https://picsum.photos/seed/ui1/720/1280"
  },
  {
    id: 2,
    category: "Payments",
    title: "One-Tap Pay",
    description: "Secure checkout in seconds, not minutes.",
    image: "https://picsum.photos/seed/ui2/720/1280"
  },
  {
    id: 3,
    category: "Rewards",
    title: "Daily Cash Back",
    description: "Earn 5% back on every single purchase.",
    image: "https://picsum.photos/seed/ui3/720/1280"
  },
  {
    id: 4,
    category: "Security",
    title: "Fraud Protection",
    description: "AI-driven security keeping your money safe.",
    image: "https://picsum.photos/seed/ui4/720/1280"
  },
  {
    id: 5,
    category: "Tracking",
    title: "Real-time Alerts",
    description: "Get notified the moment your package moves.",
    image: "https://picsum.photos/seed/ui5/720/1280"
  }
];
...
export const FeatureSlider: React.FC = () => {
  ...
  const stopDrag = () => {
    ...
    // Determine Stride
    const cards = Array.from(container.querySelectorAll('.feature-card')) as HTMLElement[];
    ...
    const targetCard = container.querySelector(`[data-id="${features[targetIndex].id}"]`) as HTMLElement;
    
    if (targetCard) {
        const scrollPos = targetCard.offsetLeft - (container.clientWidth / 2) + (targetCard.offsetWidth / 2);
  ...
  const scrollToId = (id: number) => {
      ...
      const container = scrollContainerRef.current;
      const targetCard = container.querySelector(`[data-id="${id}"]`) as HTMLElement;
    ...
    <section className="feature-section">
      <div className="feature-container">
        ...
        <div className="feature-header">
          <h2 className="feature-title">Showcasing the <span className="text-brand-primary">Future</span> of Mobile Commerce</h2>
          <p className="feature-subtitle">
            Experience a fluid interface built for modern needs.
            ...
            >
                ...
                >
                    <div className="card-visual-container">
                        <img src={feature.image} alt={feature.title} className="card-image" loading="lazy" draggable="false" />
